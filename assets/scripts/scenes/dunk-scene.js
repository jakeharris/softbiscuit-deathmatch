  ...
  var name = 'Dunk',
      ...
      handleEvent = function (e) {
        ...
        if      (key == '65')  p1d = Direction.LEFT
          ...
          this.entities[2].hasUsedReverse = true
          this.entities[3].isBeingReversed = true
        }
          ...
          this.entities[3].hasUsedReverse = true
          this.entities[2].isBeingReversed = true
        }
      ...
      for(var ent in this.entities) {
        ...
        if(en instanceof Hindrance && !en.alive) {
          if (en.player == PlayerNumber.ONE) {
            ...
            if     (en.type == Hindrances.REVERSE) this.entities[3].isBeingReversed = false
            else if(en.type == Hindrances.JITTERS) this.entities[3].isBeingJittered = false
          }
